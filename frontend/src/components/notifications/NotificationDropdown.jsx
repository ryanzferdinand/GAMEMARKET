...
export default function NotificationDropdown({ dark = false }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {/* Dropdown panel */}
      {open && (
        <div className="dropdown right-0 top-full mt-2 w-80 animate-scale-in z-50 flex flex-col max-h-[480px]" style={{ backgroundColor: 'rgba(22, 22, 24, 0.94)', backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)', border: '1px solid rgba(255, 255, 255, 0.10)', boxShadow: '0 20px 60px rgba(0,0,0,0.45)' }}>
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3 border-b shrink-0" style={{ backgroundColor: 'rgba(255, 255, 255, 0.04)', borderColor: 'rgba(255, 255, 255, 0.08)' }}>
