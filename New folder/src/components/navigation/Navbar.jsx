    ...
    <div ref={containerRef} style={{ position: 'relative', width: '100%' }}>
      ...
      {showSugg && hasSugg && (
        <div
          ...
          style={{ position: 'absolute', top: 'calc(100% + 6px)', left: 0, right: 0, backgroundColor: 'var(--bg-elevated)', border: '1px solid var(--border)', borderRadius: 14, boxShadow: '0 12px 40px rgba(0,0,0,0.2)', overflow: 'hidden', zIndex: 9999 }}
        >
...
export default function Navbar() {
  ...
  return (
    <header style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50, height: NAV_H, backgroundColor: '#000000', display: 'flex', flexDirection: 'column' }}>
                ...
                {userMenuOpen && (
                  <div className="dropdown animate-scale-in" style={{ right: 0, top: '100%', marginTop: 6, width: 230, paddingTop: 4, paddingBottom: 4 }}>
                    ...
                    <div style={{ padding: '4px 0' }}>
                      ...
                      ].map(({ to, icon: Icon, label, badge, mobileOnly }) => (
      ...
      {mobileSearch && (
        <div className="animate-fade-down" style={{ padding: '8px 12px 12px', borderTop: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'rgba(0,0,0,0.97)', backdropFilter: 'blur(20px)' }}>
